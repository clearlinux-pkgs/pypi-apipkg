...
Version  : 3.0.0
Release  : 66
URL      : https://files.pythonhosted.org/packages/34/45/c5b223313d173c05207f46854e0a2c866c45e2789450964eb2f4ba48f0b3/apipkg-3.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/34/45/c5b223313d173c05207f46854e0a2c866c45e2789450964eb2f4ba48f0b3/apipkg-3.0.0.tar.gz
...
%prep
%setup -q -n apipkg-3.0.0
cd %{_builddir}/apipkg-3.0.0
pushd ..
cp -a apipkg-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654611561
...
cp %{_builddir}/apipkg-3.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-apipkg/82dbfd684f7c04da81d4faa852c6317142daa3e7
