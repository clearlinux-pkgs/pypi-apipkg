...
Version  : 2.0.1
Release  : 50
URL      : https://files.pythonhosted.org/packages/56/db/18b33370851283f45c2acc22c58491c71b5bf3a3135afead42ddef6195d8/apipkg-2.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/56/db/18b33370851283f45c2acc22c58491c71b5bf3a3135afead42ddef6195d8/apipkg-2.0.1.tar.gz
...
%prep
%setup -q -n apipkg-2.0.1
cd %{_builddir}/apipkg-2.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633477185
...
cp %{_builddir}/apipkg-2.0.1/LICENSE %{buildroot}/usr/share/package-licenses/apipkg/82dbfd684f7c04da81d4faa852c6317142daa3e7
